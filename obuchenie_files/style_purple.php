...
{
	background: #1B161B;
	background-color: rgba(27,22,27,0.8);
}

.jssort11 .pav, .jssort11 .pdn
{
	background:#463945;
	background-color: rgba(70,57,69,0.8);
}
...
.captionYellow
{
    ...
    border-radius: 4px;
    background: #463945;
    background-color: rgba(70,57,69,0.6);
}
...
{
	content: "";
    border-color: transparent #1B161B;
    border-style: solid;
...
{
	content: "";
    border-color: #1B161B transparent;
    margin-left: 7px;
}
...
a.prev
{
	...
	background: #463945 url(/themes/theme_29/images/navigator/prev.png) center center no-repeat !important;	
}

a.prev:hover
{
	background: #1B161B url(/themes/theme_29/images/navigator/prev.png) no-repeat center center !important;
}
...
a.next
{
	padding-left: 8px !important;
	padding-right: 7px !important;	
	background: #463945 url(/themes/theme_29/images/navigator/next.png) center center no-repeat !important;	
}

a.next:hover
{
	background: #1B161B url(/themes/theme_29/images/navigator/next.png) no-repeat center center !important;
}
...
div.navigator ul li a.first
{
	padding-left: 10px;
	padding-right: 10px;	
	background: #463945 url(/themes/theme_29/images/navigator/first.png) center center no-repeat;	
}

div.navigator ul li a.first:hover
{
	background: #1B161B url(/themes/theme_29/images/navigator/first.png) no-repeat center center;
}
...
div.navigator ul li a.last
{
	padding-left: 10px;
	padding-right: 10px;	
	background: #463945 url(/themes/theme_29/images/navigator/last.png) center center no-repeat;	
}

div.navigator ul li a.last:hover
{
	background: #1B161B url(/themes/theme_29/images/navigator/last.png) no-repeat center center;
}
...
{
	box-shadow: 0 0 5px 1px #6B616A;
	border: 1px solid #6B616A;
	outline:none;
}
